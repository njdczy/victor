@include('public.header')
    ...
    <div class="body_two">
        ...
        <p style="margin-left: 0.1rem;"> 2017，让我们继续精诚合作，相携</p>
        <p style="margin-left: -0.5rem;">与共，共创“胜利”辉煌!</p>
        <!--<p>
            <p>尊敬的来宾：<br /></p>
            2017 VICTOR品牌大会暨秋冬新品<br/>
            发布会欢迎您！感谢您你始终如一的<br />
                              支持与付出。<br />
            2017，让我们继续精诚合作，相携<br />
            与共，共创“胜利”辉煌!
        </p>-->
        <a href="{{route('login')}}">获取入场凭证</a>
    </div>
    </body>
</html>